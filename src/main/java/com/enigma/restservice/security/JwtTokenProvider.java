...
public class JwtTokenProvider implements Serializable {
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + jwtProperties.getValidityMilis() * 1000))
                .compact();
    }
    ...
    UsernamePasswordAuthenticationToken getAuthentication(String token, final UserDetails userDetails) {
